...
def contact_parametr(contact, driver):
...
def contact_parametr_delete(driver):
    driver.find_element_by_name("firstname").click()
...
class ContactHelper:
    ...
    def create(self, contact):
        ...
        contact_parametr(contact, driver)
    ...
    def edit_contact(self, contact):
        ...
        contact_parametr_delete(wd)
        contact_parametr(contact, wd)
