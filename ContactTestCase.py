...
class ContactTestCase(unittest.TestCase):
    ...
    def test_contact_test_case(self):
        ...
        self.create_contacts(wd, "Ivan", "Ivanovich", "Ivanov", "ivanushka", "test", "test", "000000fff", "87899877777",
                             "5656787887", "test@gmail.com", "13", "November", "1994", "test")
    ...
    def create_contacts(self, wd, firstname, middlename, lastname, nickname, company, address, home, mobile, work,
                        email, bday, bmonth, byear, address2):
